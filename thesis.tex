...
% Frontespizio -------------------------------------------------------------------
       \title{L'architettura Microfrontend: Studio delle
        metodologie a disposizione e presentazione di un caso studio
         con oggetto la migrazione a microfrontend di un'applicazione web }
