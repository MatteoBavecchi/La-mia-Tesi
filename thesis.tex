...
% Frontespizio -------------------------------------------------------------------
       \title{L'architettura Microfrontend: Studio delle metodologie a disposizione e 
       presentazione di un progetto per la migrazione a microfrontend di un'applicazione web }
