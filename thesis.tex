...
% Frontespizio -------------------------------------------------------------------
       \title{L'approccio Microfrontend nelle applicazioni web: Studio delle
        metodologie a disposizione e presentazione dei risultati del tirocinio
         con oggetto la migrazione a microfrontend delle applicazioni web nelle
           sale di controllo X2030 di Leonardo SPA}
       \author{Matteo Bavecchi}
       \titolocorso{Ingegneria Informatica}
       \chair{Prof. Romano Fantacci \\ Prof. Tommaso Pecorella }
